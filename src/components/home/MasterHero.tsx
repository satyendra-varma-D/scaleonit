    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="text-center max-w-4xl mx-auto mb-14">
          {/* Eyebrow */}
          <div className="inline-flex items-center gap-2 font-mono text-[11px] font-bold tracking-widest uppercase text-[#FF5500] bg-orange-50 border border-orange-200 px-3.5 py-1.5 rounded-md mb-6 shadow-xs">
          ...
          <div className="inline-block font-mono text-sm sm:text-base font-bold text-slate-900 bg-slate-100 border border-slate-200 px-4 py-2 rounded-lg mb-8 shadow-2xs">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button
              ...
              className="px-7 py-3.5 rounded-lg bg-[#FF5500] hover:bg-[#E04B00] text-white font-mono font-bold text-xs uppercase tracking-wider shadow-[3px_3px_0px_0px_#0F172A] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all duration-150 cursor-pointer flex items-center gap-2"
            >
            ...
            <button
              ...
              className="px-7 py-3.5 rounded-lg bg-white hover:bg-slate-50 text-slate-800 hover:text-slate-900 font-mono font-semibold text-xs uppercase tracking-wider border border-slate-200 hover:border-slate-400 shadow-[3px_3px_0px_0px_#0F172A] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all duration-150 cursor-pointer flex items-center gap-2"
            >
