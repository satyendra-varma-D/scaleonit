...
export default function CategorySection() {
  return (
    <section id="platform-intro" className="py-28 bg-pearl overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative w-72 h-72 sm:w-80 sm:h-80">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10">
                <div className="text-center">
                  <div className="w-24 h-24 rounded-2xl bg-onit flex flex-col items-center justify-center shadow-xl shadow-onit/30 mx-auto">
                    <span className="text-white font-extrabold text-xl tracking-tight leading-none">ONIT</span>
                    <span className="text-blue-200 text-[9px] font-semibold tracking-widest uppercase mt-1">Platform</span>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute inset-6 rounded-full border border-border-base/50" />
              ...
              {orbitItems.map((item, i) => {
                ...
                return (
                  ...
                  >
                    <div className={`text-[10px] font-bold tracking-wide uppercase whitespace-nowrap ${item.color} bg-white border border-border-base px-2 py-0.5 rounded-md shadow-sm`}>
                      {item.label}
                    </div>
                  </div>
                )
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-base text-mid-text leading-relaxed mb-8 max-w-lg">
            ...
            <p className="text-sm text-mid-text leading-relaxed mb-10 max-w-lg">
