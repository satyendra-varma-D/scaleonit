...
export const lifecycleStages: LifecycleStage[] = [
  ...
  },
  {
    id: 'requirements',
    step: '02',
    name: 'Discovery & Spec Generation',
    system: 'DISCOVER',
    systemBadge: 'STAGE 02 · DISCOVER',
    actionTitle: 'BRD, FRD & Architecture Synthesis',
    description: 'Ingests unstructured sales notes and idea briefs from GROW, detects requirement gaps, matches pre-built domain templates, and redrafts custom BRDs.',
    icon: '🔍',
    color: '#3B82F6',
    inputs: ['Raw Notes from GROW', 'Client Idea Briefs', 'Domain Templates'],
    whatHappens: 'DISCOVER evaluates domain fit, redrafts custom BRD with BA/PM sign-off, generates detailed FRD, and prepares AI prompt specs.',
    output: 'Signed-off BRD, verified FRD, and selected tech stack architecture',
    liveSnippet: {
      title: 'DISCOVER · BRD & FRD Synthesizer',
      codeOrData: [
        'Domain Match: FinTech Multi-Currency Banking (92% Template Fit)',
        'Synthesized: Approved BRD + 34-Page Functional Spec (FRD)',
        'Sign-off: Approved by BA, PM & Client',
      ],
      badge: '✓ BRD/FRD Signed-Off',
    },
  },
  {
    id: 'wireframes',
    step: '03',
    name: 'UI Wireframes & Machine Specs',
    system: 'DISCOVER → DELIVER',
    systemBadge: 'STAGE 03 · BLUEPRINT',
    actionTitle: 'Interactive UI Wireframes & AI System Prompts',
    description: 'A dedicated AI prompt engineer structures .md specification files and renders interactive UI/UX wireframes for final client sign-off before coding.',
    icon: '📐',
    color: '#8B5CF6',
    inputs: ['Approved BRD & FRD', 'Brand Guidelines', 'Machine .md Specs'],
    whatHappens: 'Generates interactive UI layouts and deterministic system prompt files ready for machine execution and client visual sign-off.',
    output: 'Approved interactive UI wireframes and machine-ready system prompts',
    liveSnippet: {
      title: 'BLUEPRINT · UI & Prompt Engineer',
      codeOrData: [
        'Artifacts: Interactive Wireframes + System Prompts (.md)',
        'Deliverable: Client-Approved Visual Prototype Package',
        'Status: Ready for DELIVER (ONIT Code Engine)',
      ],
      badge: '✓ Client Prototype Approved',
    },
  },
  {
    id: 'development',
