...
export const sixSystems: SystemDomain[] = [
  ...
  },
  {
    id: 'discover',
    name: 'DISCOVER',
    tagline: 'Understand customer needs and turn them into clear requirements.',
    purpose: 'Takes customer conversations and notes and turns them into organized requirements documents that both your team and your client can agree on.',
    journey: ['Customer Notes', 'Requirements List', 'Review with Client', 'Sign Off'],
    journeyText: 'Customer Notes → Requirements List → Review with Client → Sign Off',
    description: 'Customer discovery, requirements and solution definition. Ensures everyone understands what is being built before writing code.',
    capabilities: [
      'Meeting Notes to Requirements',
      'Business Requirements Documents (BRD)',
      'Functional Specifications (FRD)',
      'User Stories & Acceptance Checks',
      'Client Review & Approval Gates',
      'Scope Change Tracking',
    ],
    intelligenceType: 'Requirements Structuring',
    intelligenceDesc: 'Organizes customer discussions into clear, structured requirements ready for review by project managers and clients.',
    status: 'building',
    statusLabel: 'Ecosystem Roadmap',
    accentColor: '#FF5500',
    bgLight: 'bg-orange-50/50',
